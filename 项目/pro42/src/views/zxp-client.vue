<template>
    <div id="data">
        <el-container>
            <el-header style="text-align: left;height: 40px">所在位置：客户信息</el-header>
            <template>
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    <el-tab-pane label="用户管理" name="first">
                        <el-main style="height: auto;overflow: hidden;">
                            ...
                            <el-button type="danger" plain style="margin-left: 20px" size="small" @click="prohibit">禁用</el-button>
                    ...
                    <el-tab-pane label="禁用管理" name="second">
                        <zxpDisabling :title="index"></zxpDisabling>
                    </el-tab-pane>
                </el-tabs>
            </template>
